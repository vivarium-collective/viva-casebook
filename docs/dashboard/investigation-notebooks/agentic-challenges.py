...
if REPO is None and Path('/Users/eranagmon/code/viva-casebook--update-readonly-workbench').is_dir():
    REPO = Path('/Users/eranagmon/code/viva-casebook--update-readonly-workbench')
if REPO is None:
    REPO = Path.cwd()
